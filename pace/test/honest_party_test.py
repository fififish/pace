...
msgContent = dict()
logChannel = Queue()
msgTypeCounter = [[0, 0] for _ in range(16)]
logGreenlet = None
...
def exit():
    ...
    #except:
    print '    Init      Echo      Val       Aux      Coin     Ready    Share     Cobalt      BiasedAux    NA'
    print '%8d %8d %9d %9d %9d %9d %9d %9d %9d  %9d' % nums[1:]
    print '%8d %8d %9d %9d %9d %9d %9d %9d %9d  %9d' % lens[1:]
